...
(defun setup-tide-mode()
  ...
  (setq tide-hl-identifier-mode +1)
  (eldoc-mode +1)
  (company-mode +1))

(add-to-list 'company-backends '(company-tide company-dabbrev))
...
#+RESULTS:
| doom--setq-emmet-expand-jsx-className?-for-rjsx-mode-h | setup-tide-mode | emmet-mode |
