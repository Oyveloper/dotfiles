...
M.modes = {
	["n"] = { "NORMAL", "Normal", "blue" },
	["no"] = { "N-PENDING", "Normal", "blue" },
	["i"] = { "INSERT", "Insert", "green" },
	["ic"] = { "INSERT", "Insert", "green" },
	["t"] = { "TERMINAL", "Insert", "green" },
	["v"] = { "VISUAL", "Visual", "purple" },
	["V"] = { "V-LINE", "Visual", "purple" },
	[""] = { "V-BLOCK", "Visual", "purple" },
	["R"] = { "REPLACE", "Replace", "red_1" },
	["Rv"] = { "V-REPLACE", "Replace", "red_1" },
	["s"] = { "SELECT", "Visual", "orange_1" },
	["S"] = { "S-LINE", "Visual", "orange_1" },
	[""] = { "S-BLOCK", "Visual", "orange_1" },
	["c"] = { "COMMAND", "Command", "yellow_1" },
	["cv"] = { "COMMAND", "Command", "yellow_1" },
	["ce"] = { "COMMAND", "Command", "yellow_1" },
	["r"] = { "PROMPT", "Inactive", "grey_7" },
	["rm"] = { "MORE", "Inactive", "yellow" },
	["r?"] = { "CONFIRM", "Inactive", "grey_7" },
	["!"] = { "SHELL", "Inactive", "grey_7" },
}
...
function M.hl.group(hlgroup, base)
	return vim.tbl_deep_extend(
		"force",
		base or {},
		{ fg = hlgroup.fg, bg = hlgroup.bg },
		base or { fg = hl_prop(hlgroup, "foreground"), bg = hl_prop(hlgroup, "background") }
	)
end
	...
	return function()
		...
		return M.hl.group(
			...
			vim.tbl_deep_extend(
				...
				{ fg = "#fff", bg = M.modes[vim.fn.mode()][3] },
				base or {}
			)
		)
	end
